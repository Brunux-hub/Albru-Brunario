...
-- 1. GTR ingresa lead
SELECT gtr_ingresar_lead('Juan Pérez', '+51956149567', 1);

-- 2. GTR asigna a asesor
SELECT gtr_asignar_asesor(1, 2, 1);
...
-- ================================================
-- CONSULTAS ÚTILES PARA TU APLICACIÓN
-- ================================================

-- Ver todos los clientes con su estado actual
-- SELECT id, nombre, dni, estado_cliente, lead_id FROM clientes ORDER BY created_at DESC;

-- Buscar cliente por DNI (para validaciones)
-- SELECT * FROM buscar_por_dni('12345678');

-- Buscar cliente por Lead ID (para validaciones)
-- SELECT * FROM buscar_por_lead('WSP_20250925_001');

-- Ver clientes listos para validar
-- SELECT * FROM obtener_para_validar();

-- Aprobar una validación
-- SELECT validar_aprobar(1, 5, 'Cliente aprobado, todos los datos correctos');
